...
&lt;p class="h6"&gt;h6. 第六回 潘仁美奉诏宣召　呼延赞单骑救驾&lt;/p&gt;</pre>
    ...
    <div class="border-example">
     <h3>花式显示标题 <small class="text-muted">With faded secondary text</small></h3>
    </div>
    <pre>&lt;h3&gt;
...
&lt;h1 class="display-6"&gt;亚侠女在家中比武&lt;/h1&gt;</pre>
    ...
    <div class="border-example">
     <p class="lead">二五方成耦，中宫有骊姬。势看俱集菀，鹤禁顿生危。</p>
    </div>
    <pre>&lt;p class="lead"&gt;
...
&lt;/blockquote&gt;</pre>
    <h6>命名源</h6>
    <p>HTML 规范要求将块引用属性放在 <code>&lt;blockquote&gt;</code> 之外。 提供属性时，将您的 <code>&lt;blockquote&gt;</code> 包装在 <code>&lt;figure&gt;</code> 中，并在 <code>.blockquote-footer</code> 类中使用 <code>&lt;figcaption&gt;</code> 或块级元素（例如 <code>&lt;p&gt;</code>）。 请务必将源作品的名称也包含在 <code>&lt;cite&gt;</code> 中。</p>
    <div class="border-example">
     <figure>
      <blockquote class="blockquote">
