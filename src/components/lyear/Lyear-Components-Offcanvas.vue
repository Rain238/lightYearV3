    ...
    <div class="border-example border-example-offcanvas p-0 bg-light overflow-hidden">
     <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasLabel">《铁崖乐府》</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example"><a class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample"> 使用链接的href </a> <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"> 使用按钮的data-bs-target </button>
     <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasExampleLabel">《越绝书》</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
       <div class="">
        以春秋末年至战国初期吴越争霸的历史事实为主干，上溯夏禹，下迄两汉，旁及诸侯列国，对这一历史时期吴越地区的汉民族政治、经济、军事、天文、地理、历法、语言等多有所涉及，被誉为“地方志鼻祖”。
       </div>
       <div class="dropdown mt-3"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"> 古文典籍 </button>
...
&lt;/div&gt;</pre>
    ...
    <p>试试下面的顶部、右侧和底部示例。</p>
    <div class="border-example"><button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">切换顶部offcanvas</button>
     <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasTopLabel">顶部Offcanvas</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
       ...
      </div>
...
&lt;div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel"&gt;
  ...
  &lt;/div&gt;
&lt;/div&gt;</pre>
    <div class="border-example"><button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">切换右侧offcanvas</button>
     <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasRightLabel">右侧Offcanvas</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
       ...
      </div>
...
&lt;div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel"&gt;
  ...
  &lt;/div&gt;
&lt;/div&gt;</pre>
    <div class="border-example"><button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">切换底部offcanvas</button>
     <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasBottomLabel">底部Offcanvas</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
...
&lt;/div&gt;</pre>
    <h5>背景</h5>
    <p>当 offcanvas 及其背景可见时，滚动 <code>&lt;body&gt;</code> 元素将被禁用。 使用 <code>data-bs-scroll</code> 属性来切换 <code></code> 滚动，使用 <code>data-bs-backdrop</code> 来切换背景。</p>
    <div class="border-example"><button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">启用正文滚动</button> <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBackdrop" aria-controls="offcanvasWithBackdrop">启用背景（默认）</button> <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">同时启用滚动和背景</button>
     <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasScrollingLabel">带正文滚动的 Offcanvas</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
     ...
     <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasWithBackdropLabel">带背景的 Offcanvas</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
       <p>.....</p>
      </div>
     ...
     <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
      <div class="offcanvas-header">
       <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">带滚动的背景</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
       <p>尝试滚动页面的其余部分以查看此选项的实际效果。</p>
      </div>
...
&lt;/div&gt;</pre>
    ...
    <p>将 <code>data-bs-toggle=“offcanvas”</code> 和 <code>data-bs-target</code> 或 <code>href</code> 添加到元素以自动分配控制权 画布外元素。 <code>data-bs-target</code> 属性接受一个 CSS 选择器来应用 offcanvas。 请务必将类 <code>offcanvas</code> 添加到 offcanvas 元素。 如果您希望它默认打开，请添加附加类 <code>show</code>。</p><strong>Dismiss</strong>
    ...
    <table class="table">
     ...
     <tbody>
      <tr>
       ...
       <td>将 offcanvas 元素切换为显示或隐藏。 <strong>在 offcanvas 元素实际显示或隐藏之前返回给调用者</strong>（即在 <code>shown.bs.offcanvas</code> 或 <code>hidden.bs.offcanvas</code>事件发生）。</td>
      </tr>
      <tr>
       <td><code>show</code></td>
       <td>显示一个 offcanvas 元素。 <strong>在 offcanvas 元素实际显示之前返回调用者</strong>（即在 <code>shown.bs.offcanvas</code> 事件发生之前）。</td>
      </tr>
      <tr>
       <td><code>hide</code></td>
       <td>隐藏 offcanvas 元素。 <strong>在 offcanvas 元素真正被隐藏之前返回给调用者</strong>（即在 <code>hidden.bs.offcanvas</code> 事件发生）。</td>
      </tr>
      <tr>
       <td><code>getInstance</code></td>
       <td><em>static</em>方法，允许您获取与 DOM 元素关联的 offcanvas 实例。</td>
      </tr>
      <tr>
       <td><code>getOrCreateInstance</code></td>
       <td><em>static</em>方法，允许您获取与 DOM 元素关联的 offcanvas 实例，或创建一个新实例以防它未初始化。</td>
      </tr>
     </tbody>
    </table>
    <h6>事件</h6>
...
<script>
export default {
name: "Lyear-Components-Offcanvas"
}
</script>
