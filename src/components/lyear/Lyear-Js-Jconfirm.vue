    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <p>插件使用用jquery-confirm v3.3.4，文档地址：<a href="https://www.jquery-confirm.cn/" target="_blank">https://www.jquery-confirm.cn/</a>
            </p>
            <div class="row">
              <div class="col-md-3">
                <p>优雅的警报。</p>
...
<script>
//对话框插件js
import {confirm} from "@/assets/css/jquery-confirm/jquery-confirm.min.js"
//对话框插件css
import "@/assets/css/jquery-confirm/jquery-confirm.min.css"

export default {
  name: "Lyear-Js-Jconfirm",
  methods: {
    fun: function () {
      confirm()
