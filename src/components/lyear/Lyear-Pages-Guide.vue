          ...
          <div class="card-body">
            <form action="#!" class="lyear-guide-box" data-navigateable="true">
              <ul class="nav nav-step">
                <li class="nav-item"><span>步骤一</span> <a class="nav-link active" data-toggle="tab"
                                                            href="#step-1"></a></li>
                <li class="nav-item"><span>步骤三</span> <a class="nav-link" data-toggle="tab" href="#step-2"></a></li>
                <li class="nav-item"><span>步骤四</span> <a class="nav-link" data-toggle="tab" href="#step-3"></a></li>
                <li class="nav-item"><span>步骤五</span> <a class="nav-link" data-toggle="tab" href="#step-4"></a></li>
              </ul><!--对应内容-->
              <div class="nav-step-content">
                <div class="nav-step-pane d-none active" id="step-1" data-provide="validation">
                  <div class="form-group"><label>姓名</label> <input class="form-control" type="text" id="username"
                                                                     required>
                  </div>
                </div>
                <div class="nav-step-pane d-none" id="step-2" data-provide="validation">
                  <div class="form-group"><label>邮箱地址</label> <input class="form-control" type="text" id="email"
                                                                         required>
                  </div>
                </div>
                <div class="nav-step-pane d-none" id="step-3" data-provide="validation">
                  <div class="form-group"><label>设置密码</label> <input class="form-control" type="password"
                                                                         id="password" required>
                  </div>
                </div>
                <div class="nav-step-pane d-none" id="step-4">
                  <div class="form-group"><label>备注</label> <input class="form-control" type="text" id="remark">
                  </div>
                </div>
              </div><!--End 对应内容-->
              <hr>
...
<script>
import {wizard} from "@/utils/jquery.bootstrap.wizard.min.js"

export default {
  name: "Lyear-Pages-Guide",
  methods: {
    fun: function () {
      wizard();
