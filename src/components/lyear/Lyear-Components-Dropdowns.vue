  ...
  <div class="card">
   ...
   <div class="card-body">
    ...
    <div class="border-example">
     <div class="dropdown"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"> 哎哟,不错哦 </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="dropdown"><a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"> 哎哟,不错哦 </a>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">哎哟,不错哦</button>
     ...
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">八度空间</button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">范特西</button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">惊叹号!</button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-warning dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">跨时代</button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">魔杰座</button>
      <ul class="dropdown-menu">
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button type="button" class="btn btn-primary">八度空间</button> <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-secondary">范特西</button> <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-success">惊叹号!</button> <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-info">跨时代</button> <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
       <li><a class="dropdown-item" href="#">说了再见</a></li>
     ...
     <div class="btn-group"><button type="button" class="btn btn-warning">魔杰座</button> <button type="button" class="btn btn-warning dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-danger">七里香</button> <button type="button" class="btn btn-danger dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button class="btn btn-secondary btn-lg dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"> 七里香 </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-lg btn-secondary">十二新作</button> <button type="button" class="btn btn-lg btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
...
&lt;/div&gt;</pre>
    <div class="border-example">
     <div class="btn-group"><button class="btn btn-secondary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"> 十二新作 </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group"><button type="button" class="btn btn-sm btn-secondary">十一月的萧邦</button> <button type="button" class="btn btn-sm btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="dropdown"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false"> 十一月的萧邦 </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid"><a class="navbar-brand" href="#">导航栏</a> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDarkDropdown" aria-controls="navbarNavDarkDropdown" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
       <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
        <ul class="navbar-nav">
         <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 编程语言 </a>
...
&lt;/nav&gt;</pre>
    <h5>方向</h5>
    <div class="callout callout-info mb-3"><strong>RTL</strong>
     <p>在 RTL 中使用 Bootstrap 时方向是镜像的，这意味着 <code>.dropstart</code> 将出现在右侧。</p>
    </div>
    <h6>Dropup</h6>
    <p>通过将 <code>.dropup</code> 添加到父元素来触发向上的下拉菜单。</p>
    <div class="border-example">
     <div class="btn-group dropup"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> 十一月的萧邦 </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group dropup"><button type="button" class="btn btn-secondary"> 十二新作 </button> <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
      <ul class="dropdown-menu">
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group dropend"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> 我很忙 </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group dropend"><button type="button" class="btn btn-secondary"> 叶惠美 </button> <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉端</span> </button>
      <ul class="dropdown-menu">
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group dropstart"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> 叶惠美 </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group">
      <div class="btn-group dropstart" role="group"><button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"> <span class="visually-hidden">切换下拉</span> </button>
       <ul class="dropdown-menu">
      ...
      </div><button type="button" class="btn btn-secondary"> 我很忙 </button>
     </div>
    </div>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="dropdown"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false"> 叶惠美 </button>
...
&lt;/ul&gt;</pre>
    ...
    <div class="callout callout-info mb-3"><strong>注意！</strong> 下拉菜单的位置要归功于 Popper，除非它们包含在导航栏中。
    </div>
    <div class="border-example">
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> 右对齐菜单示例 </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"> 大屏时左对齐但右对齐 </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"> 大屏幕时右对齐但左对齐 </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false"> 下拉 </button>
     ...
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> 右对齐菜单 </button>
      <ul class="dropdown-menu dropdown-menu-end">
     ...
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"> 左对齐，lg 右对齐 </button>
      <ul class="dropdown-menu dropdown-menu-lg-end">
     ...
     <div class="btn-group"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"> 右对齐，lg 左对齐 </button>
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
     ...
     <div class="btn-group dropstart"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Dropstart </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group dropend"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Dropend </button>
      <ul class="dropdown-menu">
     ...
     <div class="btn-group dropup"><button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Dropup </button>
      <ul class="dropdown-menu">
...
&lt;/ul&gt;</pre>
    ...
    <div class="border-example">
     <div class="dropdown-menu p-4 text-muted" style="max-width: 200px;">
      <p>以汤川学作为主角，该书里面有本格的推理，又有社会派的反思。</p>
      <p class="mb-0">伽利略的苦恼</p>
     </div>
    </div>
    ...
    <div class="border-example">
     <div class="dropdown-menu">
      <form class="px-4 py-3">
       <div class="mb-3"><label for="exampleDropdownFormEmail1" class="form-label">邮箱地址</label> <input type="email" class="form-control" id="exampleDropdownFormEmail1" placeholder="email@example.com">
       </div>
       <div class="mb-3"><label for="exampleDropdownFormPassword1" class="form-label">密码</label> <input type="password" class="form-control" id="exampleDropdownFormPassword1" placeholder="密码">
       </div>
       <div class="mb-3">
        <div class="form-check"><input type="checkbox" class="form-check-input" id="dropdownCheck"> <label class="form-check-label" for="dropdownCheck"> 记住我 </label>
        </div>
       </div><button type="submit" class="btn btn-primary">登录</button>
      </form>
      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">新用户？ 点击注册</a> <a class="dropdown-item" href="#">忘记密码？</a>
     </div>
    </div>
...
&lt;/div&gt;</pre>
    <div class="border-example">
     <form class="dropdown-menu p-4">
      <div class="mb-3"><label for="exampleDropdownFormEmail2" class="form-label">邮箱地址</label> <input type="email" class="form-control" id="exampleDropdownFormEmail2" placeholder="email@example.com">
      </div>
      <div class="mb-3"><label for="exampleDropdownFormPassword2" class="form-label">密码</label> <input type="password" class="form-control" id="exampleDropdownFormPassword2" placeholder="密码">
      </div>
      <div class="mb-3">
       <div class="form-check"><input type="checkbox" class="form-check-input" id="dropdownCheck2"> <label class="form-check-label" for="dropdownCheck2"> 记住我 </label>
       </div>
      </div><button type="submit" class="btn btn-primary">登录</button>
     </form>
    </div>
...
&lt;/form&gt;</pre>
    ...
    <div class="border-example">
     <div class="d-flex">
      <div class="dropdown me-1"><button type="button" class="btn btn-secondary dropdown-toggle" id="dropdownMenuOffset" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="10,20"> Offset </button>
      ...
      <div class="btn-group"><button type="button" class="btn btn-secondary">Reference</button> <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent"> <span class="visually-hidden">切换下拉</span> </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="btn-group"><button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false"> 默认下拉菜单 </button>
     ...
     <div class="btn-group"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuClickableOutside" data-bs-toggle="dropdown" data-bs-auto-close="inside" aria-expanded="false"> 外部可点击 </button>
     ...
     <div class="btn-group"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuClickableInside" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"> 内部可点击 </button>
     ...
     <div class="btn-group"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="false" aria-expanded="false"> 手动关闭 </button>
...
&lt;/div&gt;</pre>
    ...
    <div class="callout callout-info mb-3">
     在支持触摸的设备上，打开下拉菜单会将空的 <code>mouseover</code> 处理程序添加到 <code>&lt;body&gt;</code> 元素的直接子元素。 这个公认的丑陋黑客对于解决 <a href="https://www.quirksmode.org/blog/archives/2014/02/mouse_event_bub.html" target="_blank">iOS 事件委托中的怪癖</a>是必要的，它 否则会阻止在下拉列表之外的任何地方点击触发关闭下拉列表的代码。 关闭下拉菜单后，这些额外的空 <code>mouseover</code> 处理程序将被删除。
    </div>
    <h6>通过数据属性</h6>
...
var dropdownList = dropdownElementList.map(function (dropdownToggleEl) {
  return new bootstrap.Dropdown(dropdownToggleEl)
    ...
    <div class="callout callout-info mb-3"><strong><code>data-bs-toggle="dropdown"</code> 仍然需要</strong>
    ...
    <table class="table">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td><code>[0, 2]</code></td>
       <td><p>下拉菜单相对于其目标的偏移量。 您可以使用逗号分隔值在数据属性中传递字符串，例如：<code>data-bs-offset="10,20"</code></p><p>W当一个函数用于确定偏移量时，它会使用一个包含 popper 放置、引用和 popper rects 作为其第一个参数的对象来调用。 触发元素 DOM 节点作为第二个参数传递。 该函数必须返回一个包含两个数字的数组：<code>[<a href="https://popper.js.org/docs/v2/modifiers/offset/#skidding-1" target="_blank">skidding</a>, &lt; a href="https://popper.js.org/docs/v2/modifiers/offset/#distance-1" target="_blank"&gt;距离]</code>。</p><p>有关详细信息，请参阅 Popper 的 <a href="https://popper.js.org/docs/v2/modifiers/offset/#options" target="_blank">偏移文档</a>。</p></td>
      </tr>
      <tr>
       <td><code>autoClose</code></td>
       <td>boolean | string</td>
       <td><code>true</code></td>
       <td><p>配置下拉菜单的自动关闭行为：</p>
        <ul>
      ...
      <tr>
       ...
       <td><p>要更改 Bootstrap 的默认 Popper 配置，请参阅 <a href="https://popper.js.org/docs/v2/constructors/#options" target="_blank">Popper 的配置</a>。</p><p>当一个函数用于创建 Popper 配置时，它会使用一个包含 Bootstrap 的默认 Popper 配置的对象来调用。 它可以帮助您使用默认设置并将其与您自己的配置合并。 该函数必须为 Popper 返回一个配置对象。</p></td>
      </tr>
     </tbody>
    </table><strong>使用带有 <code>popperConfig</code> 的函数</strong>
  ...
  popperConfig: function (defaultBsPopperConfig) {
    ...
    <table class="table">
     ...
     <tbody>
      <tr>
       <td><code>toggle</code></td>
       <td>切换给定导航栏或选项卡式导航的下拉菜单。</td>
      </tr>
      <tr>
       <td><code>show</code></td>
       <td>显示给定导航栏或选项卡式导航的下拉菜单。</td>
      </tr>
      <tr>
       <td><code>hide</code></td>
       <td>隐藏给定导航栏或选项卡式导航的下拉菜单。</td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td>销毁元素的下拉列表。 （删除 DOM 元素上存储的数据）</td>
      </tr>
      <tr>
       <td><code>getInstance</code></td>
       <td>允许您获取与 DOM 元素关联的下拉实例的静态方法，您可以像这样使用它：<code>bootstrap.Dropdown.getInstance(element)</code></td>
      </tr>
      <tr>
       <td><code>getOrCreateInstance</code></td>
       <td>静态方法，它返回与 DOM 元素关联的下拉实例，或者在未初始化的情况下创建一个新实例。你可以像这样使用它：<code>bootstrap.Dropdown.getOrCreateInstance(element)</code></td>
      </tr>
     </tbody>
    </table>
    <h6>事件</h6>
    ...
    <table class="table">
     ...
     <tbody>
      <tr>
       ...
       <td>调用 show 实例方法时立即触发。</td>
      </tr>
      <tr>
       <td><code>shown.bs.dropdown</code></td>
       <td>当下拉菜单对用户可见并且 CSS 转换完成时触发。</td>
      </tr>
      <tr>
       <td><code>hide.bs.dropdown</code></td>
       <td>调用 hide 实例方法时立即触发。</td>
      </tr>
      <tr>
       <td><code>hidden.bs.dropdown</code></td>
       <td>当下拉菜单完成对用户隐藏并且 CSS 转换完成时触发。</td>
      </tr>
     </tbody>
    </table>
...
<a class="navbar-brand" href="#">导航栏</a> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDarkDropdown" aria-controls="navbarNavDarkDropdown" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
<div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
 <ul class="navbar-nav">
  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 编程语言 </a>
   <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
...
<script>
export default {
name: "Lyear-Components-Dropdowns"
}
</script>
