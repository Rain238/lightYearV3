      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h6>基本示例</h6>
            <p>在输入的任一侧放置一个附加组件或按钮。您也可以在输入的两侧放置一个。请记住将 <code>&lt;label&gt;</code>
              放在输入组之外。</p>
            <div class="border-example">
              <div class="input-group mb-3"><span class="input-group-text" id="basic-addon1">@</span> <input type="text"
                                                                                                             class="form-control"
                                                                                                             placeholder="用户名"
                                                                                                             aria-label="用户名"
                                                                                                             aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3"><input type="text" class="form-control" placeholder="收件人的用户名"
                                                   aria-label="收件人的用户名" aria-describedby="basic-addon2"> <span
              ...
              <div class="input-group mb-3"><input type="text" class="form-control" placeholder="用户名"
                                                   aria-label="用户名"> <span class="input-group-text">@</span> <input
                  type="text" class="form-control" placeholder="服务器" aria-label="服务器">
              </div>
              <div class="input-group"><span class="input-group-text">带文本区域</span> <textarea class="form-control"
                                                                                                  aria-label="带文本区域"></textarea>
              </div>
            </div>
...
&lt;/div&gt;</pre>
            <h6>包装</h6>
            <p>默认情况下，输入组通过 <code>flex-wrap: wrap</code> 进行包装，以便在输入组中适应自定义表单字段验证。您可以使用
              <code>.flex-nowrap</code> 禁用它。</p>
            <div class="border-example">
              <div class="input-group flex-nowrap"><span class="input-group-text" id="addon-wrapping">@</span> <input
                  type="text" class="form-control" placeholder="用户名" aria-label="用户名"
...
&lt;/div&gt;</pre>
            <h6>尺寸</h6>
            <p>将相对的表单大小类添加到 <code>.input-group</code> 本身，其中的内容将自动调整大小 - 无需在每个元素上重复表单控件大小类。
            </p>
            <p><strong>不支持调整单个输入组元素的大小。</strong></p>
            <div class="border-example">
              <div class="input-group input-group-sm mb-3"><span class="input-group-text"
                                                                 id="inputGroup-sizing-sm">小</span> <input type="text"
                                                                                                            class="form-control"
                                                                                                            aria-label="Sizing example input"
                                                                                                            aria-describedby="inputGroup-sizing-sm">
              </div>
              <div class="input-group mb-3"><span class="input-group-text" id="inputGroup-sizing-default">默认</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                       aria-describedby="inputGroup-sizing-default">
              </div>
              <div class="input-group input-group-lg"><span class="input-group-text" id="inputGroup-sizing-lg">大</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
...
&lt;/div&gt;</pre>
            <h6>复选框和单选框</h6>
            <p>将任何复选框或单选选项放在输入组的插件中而不是文本中。当输入旁边没有可见文本时，我们建议将
              <code>.mt-0</code> 添加到 <code>.form-check-input</code>。</p>
            <div class="border-example">
              <div class="input-group mb-3">
              ...
              <div class="input-group">
                <div class="input-group-text"><input class="form-check-input mt-0" type="radio" value=""
...
&lt;/div&gt;</pre>
            <h6>多个输入</h6>
            <p>虽然视觉上支持多个 <code>&lt;input&gt;</code>，但验证样式仅适用于具有单个 <code>&lt;input&gt;</code> 的输入组。
            </p>
            <div class="border-example">
              <div class="input-group"><span class="input-group-text">名字和姓氏</span> <input type="text"
                                                                                               aria-label="名字"
                                                                                               class="form-control">
...
&lt;/div&gt;</pre>
            ...
            <div class="border-example">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="" aria-label="带有按钮插件的示例文本"
                       aria-describedby="button-addon1">
              </div>
              <div class="input-group mb-3"><input type="text" class="form-control" placeholder="收件人用户名"
                                                   aria-label="收件人用户名" aria-describedby="button-addon2">
              ...
              <div class="input-group"><input type="text" class="form-control" placeholder="收件人用户名"
                                              aria-label="带有两个按钮插件的收件人用户名">
                <button class="btn btn-outline-secondary" type="button">按钮</button>
                <button class="btn btn-outline-secondary" type="button">按钮</button>
              </div>
            </div>
...
&lt;/div&gt;</pre>
            ...
            <div class="border-example">
              ...
              <div class="input-group mb-3"><input type="text" class="form-control" aria-label="带有下拉按钮的文本输入">
                <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">陈奕迅
                </button>
            ...
            <div class="border-example">
              <div class="input-group mb-3">
                ...
                <button type="button" class="btn btn-outline-secondary dropdown-toggle dropdown-toggle-split"
                    ...
                    class="visually-hidden">切换下拉列表</span></button>
                <ul class="dropdown-menu">
              ...
              <div class="input-group"><input type="text" class="form-control" aria-label="带分段下拉按钮的文本输入">
                <button type="button" class="btn btn-outline-secondary">选项</button>
                <button type="button" class="btn btn-outline-secondary dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown" aria-expanded="false"><span
                    class="visually-hidden">切换下拉列表</span></button>
...
&lt;/div&gt;</pre>
            ...
            <div class="border-example">
              ...
              <div class="input-group mb-3"><select class="form-select" id="inputGroupSelect02">
                <option selected>请选择...</option>
...
&lt;/div&gt;</pre>
            <h6>自定义文件输入</h6>
            <div class="border-example">
              <div class="input-group mb-3"><label class="input-group-text" for="inputGroupFile01">上传</label> <input
              ...
              <div class="input-group mb-3"><input type="file" class="form-control" id="inputGroupFile02"> <label
                  class="input-group-text" for="inputGroupFile02">上传</label>
              </div>
              <div class="input-group mb-3">
              ...
              <div class="input-group"><input type="file" class="form-control" id="inputGroupFile04"
                                              aria-describedby="inputGroupFileAddon04" aria-label="上传">
