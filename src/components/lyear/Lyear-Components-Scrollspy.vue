 ...
 <div class="col-lg-12">
  <div class="card">
   ...
   <div class="card-body">
    ...
    <div class="callout callout-info mb-3"><strong>可滚动容器和键盘访问</strong>
    ...
    <div class="border-example">
     <nav id="navbar-example2" class="navbar navbar-light bg-light px-3"><a class="navbar-brand" href="#">导航栏</a>
      <ul class="nav nav-pills">
       <li class="nav-item"><a class="nav-link" href="#scrollspyHeading1">牡丹亭</a></li>
       <li class="nav-item"><a class="nav-link" href="#scrollspyHeading2">西厢记</a></li>
       <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">四大名著</a>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <div class="row">
      <div class="col-4">
       <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column align-items-stretch p-3"><a class="navbar-brand" href="#">导航栏</a>
        <nav class="nav nav-pills flex-column"><a class="nav-link" href="#item-1">模板语法</a>
         <nav class="nav nav-pills flex-column"><a class="nav-link ms-3 my-1" href="#item-1-1">插值</a> <a class="nav-link ms-3 my-1" href="#item-1-2">指令</a>
         </nav><a class="nav-link" href="#item-2">计算属性和侦听器</a> <a class="nav-link" href="#item-3">Class 与 Style 绑定</a>
         <nav class="nav nav-pills flex-column"><a class="nav-link ms-3 my-1" href="#item-3-1">绑定 HTML Class</a> <a class="nav-link ms-3 my-1" href="#item-3-2">绑定内联样式</a>
         </nav>
        </nav>
       </nav>
      </div>
...
&gt;&lt;/div&gt;</pre>
  ...
  hasError: false
    ...
    <div class="border-example">
     <div class="row">
      <div class="col-4">
       <div id="list-example" class="list-group"><a class="list-group-item list-group-item-action" href="#list-item-1">水浒传</a> <a class="list-group-item list-group-item-action" href="#list-item-2">红楼梦</a> <a class="list-group-item list-group-item-action" href="#list-item-3">西游记</a> <a class="list-group-item list-group-item-action" href="#list-item-4">三国演义</a>
       </div>
      </div>
      <div class="col-8">
...
<script>
export default {
name: "Lyear-Components-Scrollspy"
}
</script>
