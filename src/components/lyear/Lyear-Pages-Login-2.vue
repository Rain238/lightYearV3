<template>
  <body class="center-vh images-style">
  <div class="card card-shadowed p-5 mb-0 mr-2 ml-2">
    ...
    <p class="text-center text-muted mb-0">Copyright © 2022 <a target="_blank" href="http://www.bixiaguangnian.com">笔下光年</a>. All right reserved</p>
  </div>
  </body>
</template>
<script>
export default {name: "Lyear-Pages-Login-2"}
</script>
