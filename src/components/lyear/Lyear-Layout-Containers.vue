    ...
    <table class="table">
     <thead>
      <tr>
       ...
       <th scope="col">Small<br><span class="fw-normal">≥576px</span></th>
       <th scope="col">Medium<br><span class="fw-normal">≥768px</span></th>
       <th scope="col">Large<br><span class="fw-normal">≥992px</span></th>
       <th scope="col">X-Large<br><span class="fw-normal">≥1200px</span></th>
       <th scope="col">XX-Large<br><span class="fw-normal">≥1400px</span></th>
      </tr>
     </thead>
     <tbody>
      <tr>
...
&lt;/div&gt;</pre>
    <h6>响应式容器</h6>
    <p>响应式容器允许您指定一个100%宽的类，直到达到指定的拐点，然后我们为每个更高的拐点应用最大宽度。例如：在到达 <code>sm</code> 拐点之前，<code>.container-sm</code> 的宽度为100%，在该拐点处，它将与 <code>md</code>、<code>lg</code>、<code>xl</code> 和 <code>xxl</code> 一起放大。</p>
