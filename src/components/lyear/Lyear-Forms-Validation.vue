   ...
   <div class="card-body">
    ...
    <div class="border-example">
     <form class="row g-3 needs-validation" novalidate>
      <div class="col-md-4"><label for="validationCustom01" class="form-label">姓名</label> <input type="text" class="form-control" id="validationCustom01" value="张辽" required>
       <div class="valid-feedback">
        正确
       </div>
      </div>
      <div class="col-md-4"><label for="validationCustom02" class="form-label">字</label> <input type="text" class="form-control" id="validationCustom02" value="文远" required>
       <div class="valid-feedback">
        正确
       </div>
      </div>
      <div class="col-md-4"><label for="validationCustomUsername" class="form-label">用户名</label>
      ...
      <div class="col-md-6"><label for="validationCustom03" class="form-label">城市</label> <input type="text" class="form-control" id="validationCustom03" required>
       <div class="invalid-feedback">
        请提供一个正确的城市。
       </div>
      </div>
      <div class="col-md-3"><label for="validationCustom04" class="form-label">武器</label> <select class="form-select" id="validationCustom04" required> <option selected disabled value="">请选择...</option> <option>...</option> </select>
       <div class="invalid-feedback">
        请选择你日常使用的武器。
       </div>
      </div>
      <div class="col-md-3"><label for="validationCustom05" class="form-label">邮编</label> <input type="text" class="form-control" id="validationCustom05" required>
       <div class="invalid-feedback">
        请填写正确的邮编。
       </div>
      </div>
      <div class="col-12">
       <div class="form-check"><input class="form-check-input" type="checkbox" value="" id="invalidCheck" required> <label class="form-check-label" for="invalidCheck"> 同意条款和条件 </label>
        <div class="invalid-feedback">
         你必须在提交前同意。
        </div>
       </div>
      </div>
      <div class="col-12"><button class="btn btn-primary" type="submit">提交表单</button>
      </div>
     </form>
    </div>
...
(function () {
  ...
  Array.prototype.slice.call(forms)
    ...
    <div class="border-example">
     <form class="row g-3">
      <div class="col-md-4"><label for="validationDefault01" class="form-label">姓名</label> <input type="text" class="form-control" id="validationDefault01" value="张辽" required>
      </div>
      <div class="col-md-4"><label for="validationDefault02" class="form-label">字</label> <input type="text" class="form-control" id="validationDefault02" value="文远" required>
      </div>
      <div class="col-md-4"><label for="validationDefaultUsername" class="form-label">用户名</label>
       <div class="input-group"><span class="input-group-text" id="inputGroupPrepend2">@</span> <input type="text" class="form-control" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" required>
       </div>
      </div>
      <div class="col-md-6"><label for="validationDefault03" class="form-label">城市</label> <input type="text" class="form-control" id="validationDefault03" required>
      </div>
      <div class="col-md-3"><label for="validationDefault04" class="form-label">武器</label> <select class="form-select" id="validationDefault04" required> <option selected disabled value="">请选择...</option> <option>...</option> </select>
      </div>
      <div class="col-md-3"><label for="validationDefault05" class="form-label">邮编</label> <input type="text" class="form-control" id="validationDefault05" required>
      </div>
      <div class="col-12">
       <div class="form-check"><input class="form-check-input" type="checkbox" value="" id="invalidCheck2" required> <label class="form-check-label" for="invalidCheck2"> 同意条款和条件 </label>
       </div>
      </div>
      <div class="col-12"><button class="btn btn-primary" type="submit">提交表单</button>
      </div>
...
&lt;/form&gt;</pre>
    ...
    <div class="border-example">
     <form class="row g-3">
      <div class="col-md-4"><label for="validationServer01" class="form-label">姓名</label> <input type="text" class="form-control is-valid" id="validationServer01" value="张辽" required>
       <div class="valid-feedback">
        正确
       </div>
      </div>
      <div class="col-md-4"><label for="validationServer02" class="form-label">字</label> <input type="text" class="form-control is-valid" id="validationServer02" value="文远" required>
       <div class="valid-feedback">
        正确
       </div>
      </div>
      <div class="col-md-4"><label for="validationServerUsername" class="form-label">用户名</label>
      ...
      <div class="col-md-6"><label for="validationServer03" class="form-label">城市</label> <input type="text" class="form-control is-invalid" id="validationServer03" aria-describedby="validationServer03Feedback" required>
       <div id="validationServer03Feedback" class="invalid-feedback">
        请提供一个正确的城市。
       </div>
      </div>
      <div class="col-md-3"><label for="validationServer04" class="form-label">武器</label> <select class="form-select is-invalid" id="validationServer04" aria-describedby="validationServer04Feedback" required> <option selected disabled value="">请选择...</option> <option>...</option> </select>
       <div id="validationServer04Feedback" class="invalid-feedback">
        请选择你日常使用的武器。
       </div>
      </div>
      <div class="col-md-3"><label for="validationServer05" class="form-label">邮编</label> <input type="text" class="form-control is-invalid" id="validationServer05" aria-describedby="validationServer05Feedback" required>
       <div id="validationServer05Feedback" class="invalid-feedback">
        请填写正确的邮编。
       </div>
      </div>
      <div class="col-12">
       <div class="form-check"><input class="form-check-input is-invalid" type="checkbox" value="" id="invalidCheck3" aria-describedby="invalidCheck3Feedback" required> <label class="form-check-label" for="invalidCheck3"> 同意条款和条件 </label>
...
&lt;/form&gt;</pre>
    ...
    <div class="border-example">
     <form class="was-validated">
      <div class="mb-3"><label for="validationTextarea" class="form-label">文本域</label> <textarea class="form-control is-invalid" id="validationTextarea" placeholder="必填示例文本区域" required></textarea>
       <div class="invalid-feedback">
        请在文本区输入消息。
       </div>
      </div>
      <div class="form-check mb-3"><input type="checkbox" class="form-check-input" id="validationFormCheck1" required> <label class="form-check-label" for="validationFormCheck1">选中此复选框</label>
       <div class="invalid-feedback">
        无效反馈文本示例
       </div>
      </div>
      <div class="form-check"><input type="radio" class="form-check-input" id="validationFormCheck2" name="radio-stacked" required> <label class="form-check-label" for="validationFormCheck2">切换此单选框</label>
      </div>
      <div class="form-check mb-3"><input type="radio" class="form-check-input" id="validationFormCheck3" name="radio-stacked" required> <label class="form-check-label" for="validationFormCheck3">或切换其他单选框</label>
       <div class="invalid-feedback">
        更多示例无效反馈文本
       </div>
      </div>
      <div class="mb-3"><select class="form-select" required aria-label="下拉选择示例"> <option value="">打开此选择菜单</option> <option value="1">三宝太监西洋记</option> <option value="2">三略</option> <option value="3">上古神话演义</option> </select>
       <div class="invalid-feedback">
        示例无效的选择反馈
       </div>
      </div>
      <div class="mb-3"><input type="file" class="form-control" aria-label="上传示例" required>
       <div class="invalid-feedback">
        无效的表单文件反馈示例
       </div>
      </div>
      <div class="mb-3"><button class="btn btn-primary" type="submit" disabled>提交表单</button>
      </div>
     </form>
    </div>
...
&lt;/form&gt;</pre>
    ...
    <div class="border-example">
     <form class="row g-3 needs-validation" novalidate>
      <div class="col-md-4 position-relative"><label for="validationTooltip01" class="form-label">姓名</label> <input type="text" class="form-control" id="validationTooltip01" value="张辽" required>
       <div class="valid-tooltip">
        正确
       </div>
      </div>
      <div class="col-md-4 position-relative"><label for="validationTooltip02" class="form-label">字</label> <input type="text" class="form-control" id="validationTooltip02" value="文远" required>
       <div class="valid-tooltip">
        正确
       </div>
      </div>
      <div class="col-md-4 position-relative"><label for="validationTooltipUsername" class="form-label">用户名</label>
      ...
      <div class="col-md-6 position-relative"><label for="validationTooltip03" class="form-label">城市</label> <input type="text" class="form-control" id="validationTooltip03" required>
       <div class="invalid-tooltip">
        请提供一个正确的城市。
       </div>
      </div>
      <div class="col-md-3 position-relative"><label for="validationTooltip04" class="form-label">武器</label> <select class="form-select" id="validationTooltip04" required> <option selected disabled value="">请选择...</option> <option>...</option> </select>
       <div class="invalid-tooltip">
        请选择你日常使用的武器。
       </div>
      </div>
      <div class="col-md-3 position-relative"><label for="validationTooltip05" class="form-label">邮编</label> <input type="text" class="form-control" id="validationTooltip05" required>
       <div class="invalid-tooltip">
        请填写正确的邮编。
       </div>
      </div>
