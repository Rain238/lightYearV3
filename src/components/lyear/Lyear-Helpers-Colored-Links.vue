 ...
 <div class="col-lg-12">
  <div class="card">
   ...
   <div class="card-body">
    ...
    <div class="border-example"><a href="#" class="link-primary">主色链接</a> <a href="#" class="link-secondary">次要颜色链接</a> <a href="#" class="link-success">成功颜色链接</a> <a href="#" class="link-danger">危险颜色链接</a> <a href="#" class="link-warning">警告颜色链接</a> <a href="#" class="link-info">信息颜色链接</a> <a href="#" class="link-light">浅色链接</a> <a href="#" class="link-dark">黑色链接</a>
    </div>
...
<script>
export default {
name: "Lyear-Helpers-Colored-Links"
}
</script>
