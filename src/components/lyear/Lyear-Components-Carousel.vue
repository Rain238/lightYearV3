      ...
      <div class="col-5">
       <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
         <div class="carousel-item active"><img src="../../assets/images/gallery/1.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/2.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/3.jpg" class="d-block w-100" alt="...">
         </div>
        </div>
       </div>
      </div>
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
         <div class="carousel-item active"><img src="../../assets/images/gallery/4.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/5.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/6.jpg" class="d-block w-100" alt="...">
         </div>
        </div><button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden">前</span> </button> <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden">后</span> </button>
       </div>
      </div>
     </div>
    </div>
...
&lt;/div&gt;</pre>
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
         <div class="carousel-item active"><img src="../../assets/images/gallery/7.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/8.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/9.jpg" class="d-block w-100" alt="...">
         </div>
  ...
  &lt;div class="carousel-inner"&gt;
    &lt;div class="carousel-item active"&gt;
      &lt;img src="../../assets/images/gallery/7.jpg" class="d-block w-100" alt="..."&gt;
    &lt;/div&gt;
    &lt;div class="carousel-item"&gt;
      &lt;img src="../../assets/images/gallery/8.jpg" class="d-block w-100" alt="..."&gt;
    &lt;/div&gt;
    &lt;div class="carousel-item"&gt;
      &lt;img src="../../assets/images/gallery/9.jpg" class="d-block w-100" alt="..."&gt;
    &lt;/div&gt;
  &lt;/div&gt;
...
&lt;/div&gt;</pre>
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
         <div class="carousel-item active"><img src="../../assets/images/gallery/10.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
           <h5>桃花传奇</h5>
           <p>主要讲述了主人公楚留香爱恨纠缠的感情故事。</p>
          </div>
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/1.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
           <h5>午夜兰花</h5>
        ...
        </div><button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden">前</span> </button> <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden">后</span> </button>
       </div>
      </div>
     </div>
    </div>
  ...
  &lt;div class="carousel-inner"&gt;
    &lt;div class="carousel-item active"&gt;
      &lt;img src="../../assets/images/gallery/10.jpg" class="d-block w-100" alt="..."&gt;
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
         <div class="carousel-item active"><img src="../../assets/images/gallery/3.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/4.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/5.jpg" class="d-block w-100" alt="...">
         </div>
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
         <div class="carousel-item active" data-bs-interval="10000"><img src="../../assets/images/gallery/6.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item" data-bs-interval="2000"><img src="../../assets/images/gallery/7.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/8.jpg" class="d-block w-100" alt="...">
         </div>
        </div><button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden">前</span> </button> <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden">后</span> </button>
       </div>
      </div>
     </div>
    </div>
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
        <div class="carousel-inner">
         <div class="carousel-item active"><img src="../../assets/images/gallery/9.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/10.jpg" class="d-block w-100" alt="...">
         </div>
         <div class="carousel-item"><img src="../../assets/images/gallery/1.jpg" class="d-block w-100" alt="...">
         </div>
        </div><button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControlsNoTouching" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden">前</span> </button> <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlsNoTouching" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden">后</span> </button>
       </div>
      </div>
     </div>
    </div>
     ...
     <div class="row justify-content-md-center">
      <div class="col-5">
       <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
         <div class="carousel-item active" data-bs-interval="10000"><img src="../../assets/images/gallery/2.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
           <h5>新月传奇</h5>
           <p>主要讲述了楚留香寻找新月公主为证清白的故事。</p>
          </div>
         </div>
         <div class="carousel-item" data-bs-interval="2000"><img src="../../assets/images/gallery/3.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
           <h5>鬼恋侠情</h5>
        ...
        </div><button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden">前</span> </button> <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden">后</span> </button>
       </div>
      </div>
     </div>
    </div>
    ...
    <table class="table">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td><p>如果设置为 <code>'hover'</code>，则在 <code>mouseenter</code> 上暂停轮播，并在 <code>mouseleave</code> 上继续轮播。 如果设置为 <code>false</code>，将鼠标悬停在轮播上不会暂停它。</p><p>在支持触摸的设备上，当设置为 <code>'hover'</code> 时，循环将在 <code>touchend</code> （一旦用户完成与轮播的交互）上暂停两个时间间隔，然后自动恢复。 请注意，这是对上述鼠标行为的补充。</p></td>
      </tr>
      <tr>
    ...
    <table class="table">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>当页面不可见或轮播或其父级不可见时，请勿将轮播循环到下一个。 <strong>在显示目标项目之前返回给调用者。</strong></td>
      </tr>
      <tr>
       <td><code>to</code></td>
      ...
      <tr>
       ...
       <td>允许您获取与 DOM 元素关联的轮播实例的静态方法，您可以像这样使用它：<code>bootstrap.Carousel.getInstance(element)</code></td>
      </tr>
      <tr>
       <td><code>getOrCreateInstance</code></td>
       <td>返回与 DOM 元素关联的轮播实例或创建一个新的轮播实例以防它未初始化的静态方法。你可以像这样使用它：<code>bootstrap.Carousel.getOrCreateInstance(element)</code></td>
      </tr>
     </tbody>
    </table>
    <h6>事件</h6>
...
<script>
export default {
name: "Lyear-Components-Carousel"
}
</script>
