  ...
  <div class="card">
   ...
   <div class="card-body">
    ...
    <div class="border-example">
     <ul class="nav">
      <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">选中的</a></li>
...
&lt;/ul&gt;</pre>
    ...
    <div class="border-example">
     <nav class="nav"><a class="nav-link active" aria-current="page" href="#">选中的</a> <a class="nav-link" href="#">链接</a> <a class="nav-link" href="#">链接</a> <a class="nav-link disabled">禁用的</a>
     </nav>
    </div>
    <pre>&lt;nav class="nav"&gt;
  &lt;a class="nav-link active" aria-current="page" href="#"&gt;选中的&lt;/a&gt;
...
&lt;/nav&gt;</pre>
    ...
    <p>以 <code>.justify-content-center</code> 为中心：</p>
    <div class="border-example">
  ...
  &lt;/li&gt;
&lt;/ul&gt;</pre>
    <p>与 <code>.justify-content-end</code> 右对齐：</p>
    <div class="border-example">
...
&lt;/ul&gt;</pre>
    ...
    <div class="border-example">
     <nav class="nav flex-column"><a class="nav-link active" aria-current="page" href="#">选中的</a> <a class="nav-link" href="#">链接</a> <a class="nav-link" href="#">链接</a> <a class="nav-link disabled">禁用的</a>
     </nav>
    </div>
...
&lt;/ul&gt;</pre>
    <h6>使...排满并对齐</h6>
    <p>强制您的 <code>.nav</code>’s 内容扩展两个修饰符类之一的完整可用宽度。 要使用 <code>.nav-item</code> 按比例填充所有可用空间，请使用 <code>.nav-fill</code>。 请注意，所有水平空间都被占用，但并非每个导航项都具有相同的宽度。</p>
    <div class="border-example">
     <ul class="nav nav-pills nav-fill">
      <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">选中的</a></li>
      <li class="nav-item"><a class="nav-link" href="#">更长的导航链接</a></li>
      <li class="nav-item"><a class="nav-link" href="#">链接</a></li>
      <li class="nav-item"><a class="nav-link disabled">禁用的</a></li>
     </ul>
    </div>
...
&lt;/ul&gt;</pre>
    ...
    <div class="border-example">
     <nav class="nav nav-pills nav-fill"><a class="nav-link active" aria-current="page" href="#">选中的</a> <a class="nav-link" href="#">更长的导航链接</a> <a class="nav-link" href="#">链接</a> <a class="nav-link disabled">禁用的</a>
     </nav>
    </div>
...
&lt;/ul&gt;</pre>
    ...
    <div class="border-example">
     <nav class="nav nav-pills nav-justified"><a class="nav-link active" aria-current="page" href="#">选中的</a> <a class="nav-link" href="#">更长的导航链接</a> <a class="nav-link" href="#">链接</a> <a class="nav-link disabled">禁用的</a>
     </nav>
    </div>
...
&lt;/nav&gt;</pre>
    ...
    <div class="border-example">
     <nav class="nav nav-pills flex-column flex-sm-row"><a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="#">选中的</a> <a class="flex-sm-fill text-sm-center nav-link" href="#">更长的导航链接</a> <a class="flex-sm-fill text-sm-center nav-link" href="#">链接</a> <a class="flex-sm-fill text-sm-center nav-link disabled">禁用的</a>
     </nav>
    </div>
...
&lt;/nav&gt;</pre>
    ...
    <p>请注意，导航栏，即使在视觉上被设计为带有 <code>.nav-tabs</code> 类的选项卡，也应该<strong>不</strong>被赋予 <code>role="tablist"</code> 、<code>role="tabpanel"</code> 或 <code>role="tabpanel"</code> 属性。 这些仅适用于动态选项卡式界面，如 <a href="https://www.w3.org/TR/wai-aria-practices/#tabpanel" target="_blank"><abbr title="无障碍网页倡议"> 中所述 WAI</abbr> <abbr title="可访问的富 Internet 应用程序">ARIA</abbr> 创作实践</a>。 有关示例，请参阅本节中的JavaScript 行为了解动态选项卡式界面。 <code>aria-current</code> 属性在动态选项卡式界面上不是必需的，因为我们的 JavaScript 通过在活动选项卡上添加 <code>aria-selected="true"</code> 来处理选定状态。</p>
    <h5>使用下拉菜单</h5>
    ...
    <div class="border-example">
     <ul class="nav nav-tabs">
      <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">选中的</a></li>
      <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Beyond</a>
...
&lt;/ul&gt;</pre>
    ...
    <div class="border-example">
     <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
      <li class="nav-item" role="presentation"><button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">首页</button></li>
      <li class="nav-item" role="presentation"><button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">个人简介</button></li>
      <li class="nav-item" role="presentation"><button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">联系我们</button></li>
     </ul>
...
&lt;/div&gt;</pre>
    ...
    <div class="border-example">
     <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      <li class="nav-item" role="presentation"><button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">首页</button></li>
      <li class="nav-item" role="presentation"><button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">个人简介</button></li>
      <li class="nav-item" role="presentation"><button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">联系我们</button></li>
     </ul>
...
&lt;/div&gt;</pre>
    <h6>使用数据属性</h6>
    <p>只需指定 <code>data-bs-toggle="tab"</code> 或 <code>data-bs-toggle="pill"</code> 即可激活选项卡或药丸导航，而无需编写任何 JavaScript 在一个元素上。 在 <code>.nav-tabs</code> 或 <code>.nav-pills</code> 上使用这些数据属性。</p>
    <pre>&lt;!-- Nav tabs --&gt;
...
var tab = bootstrap.Tab.getOrCreateInstance(triggerEl) // Returns a Bootstrap tab instance</pre>
    ...
    <p>如果没有选项卡处于活动状态，则不会触发 <code>hide.bs.tab</code> 和 <code>hidden.bs.tab</code> 事件。</p>
    <table class="table">
     <thead>
      <tr>
...
<script>
export default {
name: "Lyear-Components-Navs-Tabs"
}
</script>
